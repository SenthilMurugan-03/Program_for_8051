...
;u                         Allocated to registers r7 
;s                         Allocated to registers r7 
;------------------------------------------------------------
	G$main$0$0 ==.
	C$BCD_LED.c$3$0_0$1 ==.
;	BCD_LED.c:3: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
...
;	BCD_LED.c:9: s=~SW;
	...
	cpl	a
	mov	r7,a
	C$BCD_LED.c$10$2_0$2 ==.
;	BCD_LED.c:10: l=0x0F&(s);
	mov	a,#0x0f
	anl	a,r7
	mov	r6,a
	C$BCD_LED.c$11$2_0$2 ==.
;	BCD_LED.c:11: u=(s)>>4;
	mov	a,r7
	swap	a
	anl	a,#0x0f
	mov	r7,a
	C$BCD_LED.c$12$2_0$2 ==.
;	BCD_LED.c:12: if(l<=0x09 && u<=0x09)
	mov	a,r6
	add	a,#0xff - 0x09
	jc	00102$
	mov	a,r7
	add	a,#0xff - 0x09
	jc	00102$
	C$BCD_LED.c$13$2_0$2 ==.
;	BCD_LED.c:13: P1_0 = 0;
;	assignBit
	clr	_P1_0
	sjmp	00106$
00102$:
	C$BCD_LED.c$15$2_0$2 ==.
;	BCD_LED.c:15: P1_0 = 1;
;	assignBit
	setb	_P1_0
	sjmp	00106$
	C$BCD_LED.c$19$1_0$1 ==.
;	BCD_LED.c:19: }
	C$BCD_LED.c$19$1_0$1 ==.
	XG$main$0$0 ==.
	ret
