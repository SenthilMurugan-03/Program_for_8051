...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$LED_PATTERN_8_BIT.c$3$0_0$1 ==.
;	LED_PATTERN_8_BIT.c:3: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
	C$LED_PATTERN_8_BIT.c$5$1_0$1 ==.
;	LED_PATTERN_8_BIT.c:5: P0 = 0xFF;
	mov	_P0,#0xff
	C$LED_PATTERN_8_BIT.c$6$1_0$1 ==.
;	LED_PATTERN_8_BIT.c:6: while(1)
00102$:
	C$LED_PATTERN_8_BIT.c$8$3_0$2 ==.
;	LED_PATTERN_8_BIT.c:8: char a = P0;
	C$LED_PATTERN_8_BIT.c$9$2_0$2 ==.
;	LED_PATTERN_8_BIT.c:9: P0 = (a<<4)|0X0F;
	mov	a,_P0
	swap	a
	anl	a,#0xf0
	mov	r7,a
	...
	mov	_P0,a
	sjmp	00102$
	C$LED_PATTERN_8_BIT.c$12$1_0$1 ==.
;	LED_PATTERN_8_BIT.c:12: }
	C$LED_PATTERN_8_BIT.c$12$1_0$1 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
