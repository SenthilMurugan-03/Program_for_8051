...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$DOT_MATRIX_LED.c$5$0_0$1 ==.
;	DOT_MATRIX_LED.c:5: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
	C$DOT_MATRIX_LED.c$13$1_0$1 ==.
;	DOT_MATRIX_LED.c:13: while(1){
00107$:
	C$DOT_MATRIX_LED.c$15$3_0$3 ==.
;	DOT_MATRIX_LED.c:15: for(i=0;i<8;i++)
	mov	r7,#0x00
00111$:
	C$DOT_MATRIX_LED.c$17$5_0$5 ==.
;	DOT_MATRIX_LED.c:17: for(j=0;j<8;j++)
	mov	r6,#0x00
	mov	a,r7
	add	a,#_row
	mov	r4,a
	...
	mov	r5,a
00109$:
	C$DOT_MATRIX_LED.c$19$6_0$6 ==.
;	DOT_MATRIX_LED.c:19: if(i==j || i+j == 7){
	mov	a,r7
	cjne	a,ar6,00139$
	sjmp	00101$
00139$:
	...
	cjne	r3,#0x00,00110$
00101$:
	C$DOT_MATRIX_LED.c$20$7_0$7 ==.
;	DOT_MATRIX_LED.c:20: P1 = row[i];
	mov	dpl,r4
	mov	dph,r5
	clr	a
	movc	a,@a+dptr
	mov	_P1,a
	C$DOT_MATRIX_LED.c$21$7_0$7 ==.
;	DOT_MATRIX_LED.c:21: P0 = col[j];
	mov	a,r6
	mov	dptr,#_col
	movc	a,@a+dptr
	mov	_P0,a
